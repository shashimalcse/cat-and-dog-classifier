...
public class Classifier {
    ...
    private static final String MODEL_NAME = "cat&dog.tflite";
    ...
    public Classifier(AppCompatActivity activity) throws IOException {
        mInterpreter = new Interpreter(loadModelFile(activity), options);
        int[] imageShape=mInterpreter.getInputTensor(0).shape();
        Log.d("SIZEX",Integer.toString(imageShape[1]));
        Log.d("SIZEY",Integer.toString(imageShape[2]));
